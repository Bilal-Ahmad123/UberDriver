...
import com.logicbeanzs.uberpolylineanimation.RouteEvaluator


//In time you will know why i did this
object CustomMapAnimator {
    ...
    fun animateRoute(googleMap: GoogleMap, bangaloreRoute: List<LatLng>):Pair<Polyline?,Polyline?> {
        ...
        return Pair(foregroundPolyline, backgroundPolyline)
    }
